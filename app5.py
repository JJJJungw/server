...
# 모델 로드
MODEL_DIR = "C:/Users/a/Desktop/flask/models"
...
def yolo_index():
    return render_template('YOL_index2.html')
...
def predict_yolo():
    ...
    model_path = os.path.join("C:/Users/a/Desktop/flask/models", selected_model)
    ...
    if file.filename.lower().endswith(('jpg', 'jpeg', 'png')):
        ...
        return render_template('YOLO_result2.html', result_image=result_image_filename, model_name=selected_model)
    ...
    # 동영상 파일 처리
        ...
        return render_template('YOLO_result2.html', result_video=result_video_filename, model_name=selected_model)
...
def yolo_result():
    ...
    return render_template('YOLO_result2.html', result=result)
